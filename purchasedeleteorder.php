...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder7.php" id="editOrderForm">

  			<?php $orderId = $_GET['i'];

  			$sql = "SELECT product3.product_id, product3.product_name FROM product3 INNER JOIN production ON production.product_name = product3.product_name WHERE production.id = {$orderId}";
		...
		<div class="form-group" style="display:none;">
			  ...
			  <div class="form-group" >
			   ...
			   <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Client Name" autocomplete="off" value="<?php echo $data[0] ?>" />
			    </div>
			  </div> <!--/form-group-->
