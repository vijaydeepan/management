...
<div class="panel panel-default">
	...
	<div class="panel-body">
	 ...
	 <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="customer_address" placeholder="Supplier address" name="customer_address" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	 
			  <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="customer_contact" placeholder="Supplier contact" name="customer_contact" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	 
			
			  <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Gstno </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="gstno" placeholder="gstno" name="gstno" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	 
			  <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editCustomer.php" id="editOrderForm">
  			...
  			$sql = "SELECT customer.customer_id,  customer.customer_name, customer.address, customer.contact,customer.due,customer.gstno FROM customer 	
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="gst" name="gst" placeholder="Contact Number" autocomplete="off" value="<?php echo $data[5] ?>" />
			    </div>
			  </div> <!--/form-group-->	
			  <div class="form-group">
