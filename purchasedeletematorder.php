...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/deletemat.php" id="editOrderForm">

  			<?php $orderId = $_GET['i'];

  			$sql = "SELECT product5.product_id, product5.product_name FROM product5 INNER JOIN production ON production.product_name = product5.product_name WHERE production.id = {$orderId}";
