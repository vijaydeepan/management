	...
	<div class="panel-body">
			  	...
			  	<thead>
			  		<tr>			  			
						...
						<th style="width:10%;">CGST</th>
			  			...
			  			<th style="width:12%;">Producttotal</th>			  			
			  			<th style="width:12%;">quantity</th>	
			  			<th style="width:12%;">SPTotal</th>			  			
									  			<th style="width:15%;">TAXTotal</th>			  			
			  		...
			  		for($x = 1; $x < 4; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:10px;">
			  					...
			  					<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)"style="padding-left:10px;width:150px;" >
							...
							<div class="dee" style="width:10px;">		  					

			  				<td style="padding-left:20px;">	
			  					<input type="text" name="cgst[]" id="cgst<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" />			  					
			  					<input type="hidden" name="cgst[]" id="cgst<?php echo $x; ?>" autocomplete="off" class="form-control" />			  					
			  				</td>
							</div>
								...
								<td style="padding-left:10px;">			  					
			  					<input type="text" name="sgst[]" id="cgst<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" />			  					
			  					<input type="hidden" name="sgstValue[]" id="sgstValue<?php echo $x; ?>" autocomplete="off" class="form-control" />			  					
			  				</td>
								<td style="padding-left:10px;">			  					
			  					<input type="text" name="tax[]" id="tax<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" />			  					
			  					<input type="hidden" name="taxValue[]" id="taxValue<?php echo $x; ?>" autocomplete="off" class="form-control" />			  					
			  				</td>
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.sub_total,orders.tax, orders.vat, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status FROM orders 	
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    ...
				    <div class="col-sm-9">
				      ...
				      <input type="hidden" class="form-control" id="subTotalValue" name="subTotalValue" value="<?php echo $data[4] ?>" />
				 		  ...
				 		  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">Tax</label>
				    <div class="col-sm-9">
				     				      <input type="text" class="form-control" id="tax" value="<?php echo $data[5] ?>" onkeyup="gettax();" name="TaxValue" />
				      <input type="hidden" class="form-control" id="gstValue" value="<?php echo $data[5] ?>" name="gstValue" />
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label">GST</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="vat" name="vat"  value="<?php echo $data[6] ?>" disabled="true" />
				      <input type="hidden" class="form-control" id="vatValue" value="<?php echo $data[6] ?>" name="vatValue" />
				    </div>
				  </div> <!--/form-group-->		
