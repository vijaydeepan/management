		...
		if(productId == "") {
			...
			$.ajax({
				...
				success:function(response) {
					...
					$("#clientContact"+row).val(response.suplier_contact);
...
function getProductData(row = null) {
	if(row) {
		...
		if(productId == "") {
			...
			$.ajax({
				url: 'php_action/fetchSelectedProduct5.php',
				type: 'post',
				data: {productId : productId},
				dataType: 'json',
				success:function(response) {
...
tax=0;
	...
	var totalAmount = (Number($("#subTotal").val()) + tax);
...
function removeOrder(orderId = null) {
	if(orderId) {
		$("#removeOrderBtn").unbind('click').bind('click', function() {
			...
			$.ajax({
				url: 'php_action/removeOrder2.php',
				type: 'post',
				data: {orderId : orderId},
				dataType: 'json',
				success:function(response) {
...
function paymentOrder(orderId = null) {
	if(orderId) {
		...
		$.ajax({
			url: 'php_action/fetchOrderData2.php',
			type: 'post',
			data: {orderId: orderId},
			dataType: 'json',
			success:function(response) {				
