	            	...
	            	'<a href="orders.php?o=add" class="btn btn-default" style="margin-left:10px;"> <i class="glyphicon glyphicon-plus-sign"></i> Add New Order </a>'+
	   		       ...
	   		       '</div>');
							...
							$(".removeProductRowBtn").addClass('div-hide');
															$(".removeProductRowBtn2").addClass('div-hide');
...
function addRow2(key) {
 if (key.keyCode == "83") {
	...
	var tableLength = $("#productTable4 tbody tr").length;
	...
	if(tableLength > 0) {		
		tableRow = $("#productTable4 tbody tr:last").attr('id');
		nana = $("#productTable4 tbody tr:last").attr('class');
	...
	$('.chosen-select').chosen({width: "100%"});
			...
			var tr = '<tr id="row'+count+'" class="'+nana+'">'+			  				
				'<td>'+
					'<div class="form-group">'+

					'<select class="chosen-select" name="productName[]" id="productName'+count+'" onchange="getProductData9('+count+')" >'+
			...
			if(tableLength > 0) {							
				$("#productTable4 tbody tr:last").after(tr);
			} else {				
				$("#productTable4 tbody").append(tr);
			}		
...
function getProductData9(row = null) {
	if(row) {
