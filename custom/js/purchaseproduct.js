...
$(document).ready(function() {
	...
	if(divRequest == 'add')  {
		...
		var customer_name = $("#customer_name").val();
			...
			if(customer_name == "") {
				$("#customer_name").after('<p class="text-danger"> The Client Name field is required </p>');
			...
			if(customer_address == "") {
				$("#customer_address").after('<p class="text-danger"> The Contact field is required </p>');
				$('#customer_address').closest('.form-group').addClass('has-error');
			} else {
				$('#customer_address').closest('.form-group').addClass('has-success');
			} // /else
			...
			if( customer_name && customer_address) {
	            	...
	            	' <br /> <br /> '+
	            	'<a href="customer2.php?o=add" class="btn btn-default" style="margin-left:10px;"> <i class="glyphicon glyphicon-plus-sign"></i> Add New Customer </a>'+
		...
		manageOrderTable = $("#manageOrderTable").DataTable({
			'ajax': 'php_action/fetchpurchaseproduct.php',
			'order': []
		});		
		...
		$("#editOrderForm").unbind('submit').bind('submit', function() {
			...
			if(orderDate == "") {
				$("#orderDate").after('<p class="text-danger"> The Contact field is required </p>');
...
function removeOrder(brandId = null) {
	if(brandId) {
		$("#removeOrderBtn").unbind('click').bind('click', function() {
			$("#removeOrderBtn").button('loading');

			$.ajax({
				url: 'php_action/removepurchaseproduct.php',
				type: 'post',
