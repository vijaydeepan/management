...
$(document).ready(function() {
	...
	var product2Name = document.getElementsByName('product2Name[]');				
	   	...
	   	for (var x = 0; x < quantity.length; x++) {       						
			...
			if(orderDate  && paid && word && discount && paymentType && paymentStatus) {
		...
		manageOrderTable = $("#manageOrderTable").DataTable({
			'ajax': 'php_action/fetchOrderversion2.php',
			'order': []
		});		
...
function addRow2(key) {
	...
	$.ajax({
		url: 'php_action/fetchProductDataversion4.php',
		type: 'post',
		dataType: 'json',
		success:function(response) {
...
function addRow(key) {
	...
	$.ajax({
		url: 'php_action/fetchProductDataversion5.php',
		type: 'post',
		dataType: 'json',
		success:function(response) {
...
function addRow3(key) {
	...
	$.ajax({
		url: 'php_action/fetchProductDataversion6.php',
		type: 'post',
		dataType: 'json',
		success:function(response) {
			$("#addRowBtn").button("reset");			
...
function getProductData(row = null) {
	if(row) {
		...
		if(productId == "") {
			...
			$.ajax({
				url: 'php_action/fetchSelectedProductversion.php',
				type: 'post',
				data: {productId : productId},
				dataType: 'json',
				success:function(response) {
...
function getProductData2(row = null) {
	if(row) {
		...
		if(productId == "") {
			...
			$.ajax({
				url: 'php_action/fetchSelectedProductversion3.php',
				type: 'post',
				data: {productId : productId},
				dataType: 'json',
				success:function(response) {
...
function getProductData10(row = null) {
	if(row) {
		...
		if(productId == "") {
			...
			$.ajax({
				url: 'php_action/fetchSelectedProductversion9.php',
				type: 'post',
				data: {productId : productId},
				dataType: 'json',
				success:function(response) {
...
function getProductData3(row = null) {
	if(row) {
		...
		if(productId == "") {
			...
			$.ajax({
				url: 'php_action/fetchSelectedProductversion1.php',
				type: 'post',
				data: {productId : productId},
				dataType: 'json',
				success:function(response) {
