...
$(document).ready(function() {
	...
	manageProductTable = $('#manageProductTable').DataTable({
		'ajax': 'php_action/fetchpurchasepayment.php',
		'order': []
	});
...
function editProduct(brandId = null) {
	...
	if(row) {
		...
		if(productId == "") {
			...
			$.ajax({
				url: 'php_action/fetchSelectedProduct8.php',
				type: 'post',
				data: {productId : productId},
				dataType: 'json',
				success:function(response) {
					...
					$("#total_quantity1"+row).val(response.note);

									$("#deepan1"+row).val(response.customer_name);
...
function removeProduct(brandId = null) {
	if(brandId) {
		...
		$("#removeProductBtn").unbind('click').bind('click', function() {
			...
			$.ajax({
				url: 'php_action/removepurchasepay.php',
				type: 'post',
				data: {brandId: brandId},
				dataType: 'json',
				success:function(response) {
