...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createproduct5.php" id="createOrderForm">

	 <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Color Name </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="color_name" placeholder="color_name" name="color_name" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	        
	  
	 <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Rate </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="selling_price" placeholder="selling_price" name="selling_price" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	       
