...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/deletealu.php" id="editOrderForm">

  			<?php $orderId = $_GET['i'];

  			$sql = "SELECT product1.product_id, product1.product_name FROM product1 INNER JOIN production ON production.product_name = product1.product_name WHERE production.id = {$orderId}";
