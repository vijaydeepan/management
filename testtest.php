...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createtest.php" id="createOrderForm">
	  ...
	  <table class="table" id="productTable4">
			  	<thead>
			  		<tr>			  			
			  		...
			  		for($y = 1; $y < 3; $y++) { ?>
			  			<tr id="row<?php echo $y; ?>" class="<?php echo $nana; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="chosen-select" name="productName[]" id="productName<?php echo $y; ?>" onchange="getProductData9(<?php echo $y; ?>)" >
			  						<option value="">~~SELECT~~</option>
			  					<?php
			  							$productSql2 = "SELECT production.id,production.product_name FROM production INNER JOIN product1 WHERE production.product_name=product1.product_name ";
			  							$productData = $connect->query($productSql2);
								...
								<td style="padding-left:20px;">			  					
			  					<input type="text" name="hsn[]" id="hsn<?php echo $y; ?>" autocomplete="off" disabled="true" class="form-control" />			  					
			  					<input type="hidden" name="hsnValue[]" id="hsnValue<?php echo $y; ?>" autocomplete="off" class="form-control" />			  					
			  				</td>
							<td style="padding-left:20px;">
			  					<div class="form-group">
			  					<input type="number" name="quantity[]" id="quantity<?php echo $y; ?>" onkeyup="getTotal(<?php echo $y ?>)" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				
			  				<td>

			  					<button class="btn btn-default removeProductRowBtn2" type="button" id="removeProductRowBtn2" onclick="removeProductRow2(<?php echo $y; ?>)"><i class="glyphicon glyphicon-trash"></i></button>
			  				</td>
			  			</tr>
		  			<?php
		  			$nana++;
