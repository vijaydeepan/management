	...
	<div class="panel-body">
		...
		// /else manage order
			...
			<div class="success-messages"></div> <!--/success-messages-->
  			...
  			$sql = "SELECT product_name,selling_price FROM production 	
					WHERE id = {$orderId}";
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Customer Name</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="orderDate" name="orderDate" autocomplete="off" value="<?php echo $data[0] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Customer address</label>
			    <div class="col-sm-10">
