...
<div class="panel panel-default">
	...
	<div class="form-group">
			    ...
			    <div class="col-sm-10">
			  					...
			  					<select class="chosen-select" name="product2Name" id="product2Name" onchange="getProductData" >
			  						<option value="">~~SELECT~~</option>
			  							...
			  							while($row = $productData->fetch_array()) {									 		
			  								echo "<option value='".$row['order_id']."' id='changeProduct".$row['billno']."'>".$row['billno']."</option>";
										 	} // /while 
			  				...
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						...
			  						<?php
			  							...
			  							while($row = $productData->fetch_array()) {									 		
			  								echo "<option value='".$row['id']."' id='changeProduct".$row['expensename']."'>".$row['expensename']."</option>";
										 	} // /while 
  ...
  <div class="col-md-10">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">Total Purchase Expense</label>
				    <div class="col-sm-9">
...
<script src="custom/js/order3.js"></script>
