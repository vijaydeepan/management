	 ...
	 <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editSupplier.php" id="editOrderForm">
  			...
  			$sql = "SELECT supliers.suplier_id,  supliers.suplier_name, supliers.suplier_address, supliers.suplier_contact,supliers.note ,supliers.gst FROM supliers 	
			  ...
			  <div class="form-group">
			    ...
			    <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">GST Number</label>
			    <div class="col-sm-10">
