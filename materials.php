...
">Raw Materials</h3>			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="remove-messages"></div>
					...
					<button class="btn btn-default button1" data-toggle="modal" data-target="#addProductModel"><img src="9.png" width="30" />  <i class="glyphicon glyphicon-plus-sign"></i> Add Materials </button>
				</div> <!-- /div-action -->		
