...
<div class="form-group">
  ...
  <div class="col-sm-8">
			   ...
			   <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Taken for production: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
...
<div class="modal fade" tabindex="-1" role="dialog" id="addProductModel">
 ...
 <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Box: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rate" placeholder="box" name="rate" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	
		   ...
		   <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rate2" placeholder="rate2" name="rate2" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	
	      </div> <!-- /modal-body -->
...
<script src="custom/js/product5.js"></script>
