...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="editOrderForm">

  			<?php $orderId = $_GET['i'];

  			$sql = "SELECT production_size.id,production_size.production_id, production_size.product_id,production_size.quantity FROM production_size 	
					WHERE production_size.production_id = {$orderId}";
			  ...
			  <div class="form-group"style="display:none;" >
			  					...
			  					<select class="form-control" name="product_name" id="product_name" onchange="getProductData" >
			  						...
			  						<?php
			  							...
			  							while($row = $productData->fetch_array()) {									 		
			  								...
			  								echo "<option value='".$row['product_name']."' id='changeProduct".$row['product_name']."' ".$selected." >".$row['product_name']."</option>";
										 	} // /while 
			    ...
			    <div class="col-sm-10">
			  					...
			  					<select class="form-control" name="product_name5" id="product_name5" onchange="getProductData" >
			  						<option value="">~~SELECT~~</option>
			  						<?php
			  							$productSql = "SELECT * FROM production ";
			  							$productData = $connect->query($productSql);
		...
		<div class="form-group">
			  ...
			  <div class="form-group"style="display:none;" >
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="Quantity2" name="Quantity2" placeholder="quantity" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->	
			  ...
			  <table class="table" id="productTable" style="display:none;">
			  	<thead>
			  		...
			  		$orderItemSql = "SELECT production_size.id, production_size.production_id, production_size.product_id, production_size.quantity FROM production_size WHERE production_size.production_id = {$orderId}";
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control" name="product_id[]" id="product_id<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						<option value="">~~SELECT~~</option>
			  						<?php
