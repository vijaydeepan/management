...
<div class="row">
	...
	<div class="div-action pull pull-right" style="padding-bottom:20px;">			
				 ...
				 <div class="dropdown">
    <button class="btn btn-default button1" type="button" data-toggle="dropdown">  <img src="2.png" width="30" />  <i class="glyphicon glyphicon-plus-sign"> </i> Suplier Payment
   </button>
    <ul class="dropdown-menu">
      <li>	<button class="btn btn-default button" data-toggle="modal" data-target="#addreturnModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Suplier Payment </button></li>
      <li><button class="btn btn-default button1" onclick="location.href = 'managepurchasepayment.php';"> <i class="glyphicon glyphicon-plus-sign"></i> Manage  Suplier Payment </button></li>
    </ul>
  </div>  </div>
						<div class="div-action pull pull-right" style="padding-bottom:20px;">
	
					<button class="btn btn-default button1" data-toggle="modal" data-target="#addBrandModel"><img src="5.png" width="30" /> <i class="glyphicon glyphicon-plus-sign"></i>Dealer Payment </button>
				</div> <!-- /div-action -->				
...
<div class="modal fade" id="addBrandModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitBrandForm" action="php_action/salespayment.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Add sales due Payment</h4>
	      </div>
...
<div class="form-group">
    ...
    <label for="orderDate" class="col-sm-3 control-label">Suplier Name</label>
			    ...
			    <div class="col-sm-8">
							   ...
							   <label for="orderDate" class="col-sm-3 control-label">Need To Pay</label>
					        	<label class="col-sm-1 control-label">: </label>
  ...
  <div class="col-sm-8">
			   ...
			   <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Payment Now </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
...
<div class="modal fade" id="addreturnModel" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitBrandForm" action="php_action/purchasepayment.php" method="POST">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Add Purchase due Return</h4>
	      </div>
	      <div class="modal-body">
	...
	<tbody>
			  		...
			  		for($x = 1; $x < 2; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
			  					<div class="form-group">
    <label for="orderDate" class="col-sm-3 control-label">Customer Name</label>
					        	<label class="col-sm-1 control-label">: </label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="addProductModel">
 ...
 <div class="form-group">
		   ...
		   <div class="form-group" >
	        	<label for="rate" class="col-sm-3 control-label">Box quantity </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
