...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editacp.php" >
            ...
            <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="quantity" placeholder="selling_price" name="quantity" autocomplete="off" value="<?php echo $data[2] ?>">
				    </div>
	        </div> <!-- /form-group-->			
	     <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Alt Quantity </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
