			    ...
			    <div class="col-sm-10">
				 ...
				 <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
						...
						<th style="width:10%;">Hns</th>
			  			<th style="width:15%;">Quantity per Piece/kg</th>			  			
			  	...
			  	<tbody>
			  		...
			  		$arrayNumber5 = 0;
			  		for($x = 1; $x < 6; $x++) { ?>
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber5; ?>">			  				
			  				<td style="margin-left:20px;">
			  					<div class="form-group">

			  					<select multiple class="chosen-select" name="productName2[]" id="productName2<?php echo $x; ?>" onchange="getProductData5(<?php echo $x; ?>)" >
			  						<option value="">~~SELECT~~</option>
			  					<?php
								...
								<td style="padding-left:20px;">			  					
			  					<input type="text" name="hsn2[]" id="hsn2<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" />			  					
			  					<input type="hidden" name="hsnValue2[]" id="hsnValue2<?php echo $x; ?>" autocomplete="off" class="form-control" />			  					
			  				</td>
							<td style="padding-left:20px;">
			  					<div class="form-group">
			  					<input type="number" name="quantity2[]" id="quantity2<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" />
			  					</div>
			  				</td>
			  				<td style="padding-left:20px;">			  					
			  					<input type="text" name="rate2[]" id="rate2<?php echo $x; ?>" autocomplete="off"  class="form-control" />			  					
			  					<input type="hidden" name="rateValue2[]" id="rateValue2<?php echo $x; ?>" autocomplete="off" class="form-control" />			  					
			  				</td>
			  				
			  				<td style="padding-left:20px;">			  					
			  					<input type="text" name="total2[]" id="total2<?php echo $x; ?>" autocomplete="off" class="form-control" disabled="true" />			  					
			  					<input type="hidden" name="totalValue2[]" id="totalValue2<?php echo $x; ?>" autocomplete="off" class="form-control" />			  					
			  				</td>
			  				<td>
	  ...
	  <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders3.order_id, orders3.order_date, orders3.client_name, orders3.client_contact, orders3.sub_total,orders3.tax, orders3.vat, orders3.total_amount, orders3.discount, orders3.grand_total, orders3.paid, orders3.due, orders3.payment_type, orders3.payment_status,orders3.billno,orders3.cgst,orders3.sgst,orders3.igst,orders3.cgsttotal,orders3.sgsttotal,orders3.igsttotal FROM orders3	
