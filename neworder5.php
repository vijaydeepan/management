...
SELECT production.id,production.product_name FROM production INNER JOIN product3 WHERE production.product_name=product3.product_name ";
							...
							<td style="padding-left:20px;">			  					
			  					...
			  					<input type="hidden" name="rateValue[]" id="rateValue<?php echo $x; ?>" autocomplete="off" class="form-control" />			  					
									...
									<td style="padding-left:20px;">			  					
			  					<input type="text" name="discount[]" id="discount<?php echo $x; ?>" autocomplete="off"  class="form-control" />			  					
			  					<input type="hidden" name="discountValue[]" id="discountValue<?php echo $x; ?>" autocomplete="off" class="form-control" />			  					
			  				</td>
	  ...
	  <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="grandTotal"onkeyup="word.innerHTML=convertNumberToWords(this.value)" name="grandTotal" disabled="true" />
...
<div id="word"></div>
	  ...
	  <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/NeweditOrder1.php" >
  	...
  	<tbody>
			  ...
			  <table class="table" id="productTable">
			  	...
			  	<tbody>
			  		...
			  		$orderItemSql = "SELECT order_item8.order_item_id, order_item8.order_id, order_item8.product_id,order_item8.hsn,order_item8.feet, order_item8.quantity, order_item8.rate,order_item8.discount, order_item8.total,order_item8.size,order_item8.altquantity FROM order_item8 WHERE order_item8.order_id = {$orderId}";
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				<td style="margin-left:20px;">
								...
								<td style="padding-left:20px;">			  					
			  					<input type="foot" name="alquantity[]" id="alquantity<?php echo $x; ?>" autocomplete="off"  class="form-control" value="<?php echo $orderItemData['altquantity']; ?>" />			  					
			  						  					
			  				</td>
									<td style="padding-left:20px;">			  					
			  					<input type="foot" name="foot[]" id="foot<?php echo $x; ?>" autocomplete="off"  class="form-control" value="<?php echo $orderItemData['feet']; ?>" />			  					
								...
								<td style="padding-left:20px;">			  					
			  					<input type="foot" name="discount[]" id="discount<?php echo $x; ?>" autocomplete="off"  class="form-control" value="<?php echo $orderItemData['discount']; ?>" />			  					
	  ...
	  <div class="form-group">
				  ...
				  <div class="form-group" style="display:none;">
				    <label for="discount" class="col-sm-3 control-label">Discount</label>
				    <div class="col-sm-9">
				      <input type="text" value="0" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" value="<?php echo $data[8] ?>" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">Grand Total</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="grandTotal"onkeyup="word.innerHTML=convertNumberToWords(this.value)" name="grandTotal" disabled="true" value="<?php echo $data[9] ?>"/>
