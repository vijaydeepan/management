	...
	<div class="panel-body">
		...
		// /else manage order
			...
			<div class="success-messages"></div> <!--/success-messages-->
						...
						<form class="form-horizontal" method="POST" action="php_action/editaveproduct.php" id="editOrderForm">

  			<?php $orderId = $_GET['i'];
                     
  			$sql = "SELECT production.id, production.product_name,production.selling_price,production.hns,production.quantity FROM production INNER JOIN product1 ON product1.product_name = production.product_name	
					WHERE id = {$orderId}";
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Product Name</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="orderDate" name="orderDate" autocomplete="off" value="<?php echo $data[1] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Selling price</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Selling price" autocomplete="off" value="<?php echo $data[2] ?>" />
			    </div>
			  </div> <!--/form-group-->
			<div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">HNS</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="hns" name="hns" placeholder="Selling price" autocomplete="off" value="<?php echo $data[3] ?>" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Quantity</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="quantity" name="quantity" placeholder="Selling price" autocomplete="off" value="<?php echo $data[4] ?>" />
			    </div>
			  </div> <!--/form-group-->
...
<script src="custom/js/ave.js"></script>
