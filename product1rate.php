...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	Add Product Rate
		<?php } else if($_GET['o'] == 'manord') { ?>
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createproduct1rate.php" id="createOrderForm">

	 <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">Product rate<label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="product_rate" placeholder="product_rate" name="product_rate" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	        
