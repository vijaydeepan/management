...
<input type="hidden" name="orderDate" value="<?php echo $_GET['orderDate']; ?>" />
...
<input type="text" size="25" value="" name="number" id="number" autocomplete="off" placeholder="customer phoneno" style="width: 268px; height:30px;" />
 ...
 <input type="text" size="25"  name="orderDate" id="orderDate" value="<?php echo date("m/d/y"); ?>"  autocomplete="off" placeholder="Enter date" style="width: 268px; height:30px;" />    
