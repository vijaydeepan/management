...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder4.php" id="createOrderForm">
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
						...
						<th style="width:10%;">Hns</th>
			  			<th style="width:15%;">Quantity</th>			  			

			  			<th style="width:15%;">Rate per Piece/kg</th>
	  ...
	  <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/deleteorder.php" >

  			<?php $orderId = $_GET['i'];

  			$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.sub_total,orders.tax, orders.vat, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status,orders.billno,orders.cgst,orders.sgst,orders.igst,orders.cgsttotal,orders.sgsttotal,orders.igsttotal,orders.gstno,sub_total,total_amount FROM orders	
	  ...
	  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="gstno" name="gstno" placeholder="Contact Number" autocomplete="off" value="<?php echo $data[21] ?>" />
			    </div>
			  </div> <!--/form-group-->			
			  <table class="table" id="productTable">
			  	<thead>
			  	...
			  	<tbody>
			  		...
			  		$orderItemSql = "SELECT order_item.order_item_id, order_item.order_id, order_item.product_id, order_item.quantity, order_item.rate, order_item.total,order_item.hns FROM order_item WHERE order_item.order_id = {$orderId}";
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
							...
							<td style="padding-left:20px;">			  					
			  					<input type="text" name="hsn[]" id="hsn<?php echo $x; ?>" autocomplete="off"  class="form-control" value="<?php echo $orderItemData['hns']; ?>" />			  					
			  					<input type="hidden" name="hsnValue[]" id="hsnValue<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $orderItemData['hns']; ?>" />			  					
			  				</td>
			  				<td style="padding-left:20px;">			  					
			  				...
			  				<td style="padding-left:20px;">
			  					<div class="form-group">
			  					<input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control"  value="<?php echo $orderItemData['quantity']; ?>" />
			  					</div>
			  				</td>
			  				<td style="padding-left:20px;">			  					
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">Sub Amount</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="subTotal" name="subTotal" value="<?php echo $data[22] ?>"  />
				      <input type="hidden" class="form-control" id="subTotalValue" value="<?php echo $data[22] ?>" name="subTotalValue" />
				    </div>
				  </div> <!--/form-group-->
	<div class="form-group">
				    <label for="tax" class="col-sm-3 control-label">CGST</label>
				    <div class="col-sm-9">
				      <input type="number" class="form-control" id="tax" onkeyup="gettax();" value="<?php echo $data[15] ?>" name="tax" autocomplete="off"  />
				    </div>
				  </div> <!--/form-group-->					  
				 ...
				 <div class="form-group">
				    <label for="tax" class="col-sm-3 control-label">SGST</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="tax2" onkeyup="gettax();"value="<?php echo $data[16] ?>" name="tax2" autocomplete="off"  />
				    </div>
				  </div> <!--/form-group-->	
	  ...
	  <div class="form-group">
				    <label for="tax" class="col-sm-3 control-label">IGST</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="tax3" onkeyup="gettax();" value="<?php echo $data[17] ?>" name="tax3" autocomplete="off"  />
				    </div>
				  </div> <!--/form-group-->	
				    ...
				    <label for="totalAmount" class="col-sm-3 control-label">Total Amount</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="totalAmount" name="totalAmount" value="<?php echo $data[23] ?>" />
				      <input type="hidden" class="form-control" id="totalAmountValue" value="<?php echo $data[23] ?>" name="totalAmountValue" />
				    </div>
				  </div> <!--/form-group-->		
		   ...
		   <div class="form-group">
				    <label for="discount" class="col-sm-3 control-label">Discount</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" value="<?php echo $data[8] ?>" autocomplete="off" />
				    </div>
				  </div> <!--/form-group-->	
				    ...
				    <label for="grandTotal" class="col-sm-3 control-label">Grand Total</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="grandTotal" name="grandTotal" value="<?php echo $data[9] ?>"/>
				      <input type="hidden" class="form-control" id="grandTotalValue" value="<?php echo $data[9] ?>" name="grandTotalValue" />
				    </div>
				  </div> <!--/form-group-->			  		  
			  </div> <!--/col-md-6-->
			  <div class="col-md-6">
				    ...
				    <label for="vat" class="col-sm-3 control-label">CGST Total</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="vat" value="<?php echo $data[18] ?>" name="vat"  />
				  ...
				  <div class="form-group">
				    <label for="vat2" class="col-sm-3 control-label">SGST Total</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="vat2" value="<?php echo $data[19] ?>" name="vat2" />
				    ...
				    <label for="vat3" class="col-sm-3 control-label">IGST Total</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="vat3" value="<?php echo $data[20] ?>" name="vat3"  />
			  ...
			  <div class="form-group editButtonFooter">
			    ...
			    <button type="submit" id="editOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Delete Products</button>
