...
$sql = "SELECT order_id, order_date, client_name, billno,purchasexpense, payment_status FROM orders4 WHERE order_status = 1";
...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	$countOrderItemSql = "SELECT count(*) FROM order_item2 WHERE order_id = $orderId";
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
		...
		<li><a href="orders5.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Viewbill</a></li>
	    
		<li><a href="deleteorder5.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Deletebill</a></li>

			    <li><a href="purchasevieworder.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> View expense</a></li>
