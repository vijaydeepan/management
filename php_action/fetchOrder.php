...
$sql = "SELECT order_id, order_date, client_name, billno,purchasexpense, payment_status FROM orders WHERE order_status = 1";
 ...
 while($row = $result->fetch_array()) {
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a href="orders.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Viewbill</a></li>
	    	
				    <li><a href="deleteorder.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Deletebill</a></li>
