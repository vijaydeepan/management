...
$sql = "SELECT order_id, order_date, client_name, billno, due FROM orders3 WHERE order_status = 1";
...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	$countOrderItemSql = "SELECT count(*) FROM order_item6 WHERE order_id = $orderId";
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a href="salesbill.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> View Bill</a></li>
		
				  <li><a href="deleteSalebill.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Deletebill</a></li>
