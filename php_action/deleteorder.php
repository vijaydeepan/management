...
if($_POST) {	
  ...
  $cgst 					= $_POST['tax'];
	...
	$sql = "UPDATE orders SET order_date = '$orderDate',client_name = '$clientName',billno = '$billno',gstno = ' $gst',discount = '$discount',grand_total = '$grandTotalValue',paid = '$paid',due = '$dueValue',payment_type = '$paymentType',payment_status = '$paymentStatus',cgst = '$cgst',sgst = '$sgst',igst = '$igst',cgsttotal = '$cgsttotal',sgsttotal = '$sgsttotal',igsttotal = '$igsttotal',sub_total = '$subtotal',total_amount= '$totalamount',
	...
	for($x = 0; $x < count($_POST['productName']); $x++) {			
		...
		while ($updateProductQuantityResult = $updateProductQuantityData->fetch_row()) {
			$updateQuantity[$x] = $updateProductQuantityResult[0] - $_POST['quantity'][$x];							
				...
				VALUES ({$orderId},'".$_POST['productName'][$x]."','".$_POST['hsnValue'][$x]."','".$_POST['quantity'][$x]."','".$_POST['rate'][$x]."', '".$_POST['totalValue'][$x]."', 1)";
	...
	$valid['success'] = true;
	$valid['messages'] = "All Product Successfully Deleted";	
