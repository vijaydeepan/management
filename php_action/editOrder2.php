		...
		for($x = 0; $x < count($_POST['productName']); $x++) {			
			...
			while ($updateProductQuantityResult = $updateProductQuantityData->fetch_row()) {
				$updateQuantity[$x] = $updateProductQuantityResult[0] - $_POST['quantity'][$x];							
					...
					// add into order_item
				$orderItemSql = "INSERT INTO order_item2 (order_id, product_id, quantity, rate,box,tquantity, total, order_item_status) 
				VALUES ({$orderId}, '".$_POST['productName'][$x]."', '".$_POST['quantity'][$x]."', '".$_POST['rateValue'][$x]."','".$_POST['quantity3'][$x]."','".$_POST['total2'][$x]."', '".$_POST['totalValue'][$x]."', 1)";
