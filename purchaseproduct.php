	...
	<div class="panel-body">
	 ...
	 <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editpurchaseproduct.php" id="editOrderForm">

  			<?php $brandId = $_GET['i'];

  			$sql = "SELECT purchase_product.id,  purchase_product.product_name, purchase_product.rate ,purchase_product.box FROM purchase_product 	
					WHERE purchase_product.id = {$brandId}";
			  ...
			  <div class="form-group">
			    <label for="clientName" class="col-sm-2 control-label">Rate</label>
			    <div class="col-sm-10">
			    ...
			    <label for="clientContact" class="col-sm-2 control-label">box</label>
			    <div class="col-sm-10">
...
<script src="custom/js/purchaseproduct.js"></script>
