...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> Remove Production Size
		<?php } ?>
	...
	<div class="panel-body">
		...
		<div class="form-group" style="display:none;">
			  ...
			  <div class="form-group editButtonFooter">
			    ...
			    <button type="Delete" id="editOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Delete</button>
