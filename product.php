...
<div class="modal fade" id="addProductModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
			   ...
			   <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="costprice" placeholder="costprice" name="costprice" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	   
	        ...
	        <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rate" placeholder="Rate" onkeyup="gettax();" name="rate" autocomplete="off">
					  <p>Please reenter if you change the costprice </p>
				    </div>
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="profit" placeholder="profit" name="profit" autocomplete="off">
			 ...
			 <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-3">
				      <input type="text" class="form-control" id="cgst" placeholder="cgst" onkeyup="gettax();" name="cgst" autocomplete="off">
					  
				    </div>
	        </div> <!-- /form-group-->
				 <div class="form-group">
	        	<label for="cgst" class="col-md-3 control-label">CGST:Total </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-3">
				      <input type="text" class="form-control" id="cgsttotal" placeholder="cgsttotal" onkeyup="gettax();" name="cgsttotal" autocomplete="off">
			 ...
			 <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-3">
				      <input type="text" class="form-control" id="sgst" placeholder="sgst" onkeyup="gettax();" name="sgst" autocomplete="off">
					  
				    </div>
					
	        </div> <!-- /form-group-->
					 <div class="form-group">
	        	<label for="sgst" class="col-sm-3 control-label">SGST:Total </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-3">
				      <input type="text" class="form-control" id="sgsttotal" placeholder="sgsttotal" onkeyup="gettax();" name="sgsttotal" autocomplete="off">
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="tax" placeholder="tax" name="tax" autocomplete="off">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="total" placeholder="total" name="total" autocomplete="off">
	...
	var cgsttotal = (Number($("#rate").val())/100) * cgst;
	cgsttotal = cgsttotal.toFixed(2);
	$("#cgsttotal").val(cgsttotal);
	$("#cgsttotal").val(cgsttotal);
		
		    var sgst = parseInt(document.getElementById('sgst').value);
			var sgsttotal = (Number($("#rate").val())/100) * sgst;
sgsttotal = sgsttotal.toFixed(2);
	$("#sgsttotal").val(sgsttotal);
	$("#sgsttotal").val(sgsttotal);
		
			 
			 var tax= (Number($("#cgsttotal").val()) + Number($("#sgsttotal").val()));
			 tax = tax.toFixed(2);
	$("#tax").val(tax);
			 
			  var total= (Number($("#rate").val()) + Number($("#tax").val()));
			 total = total.toFixed(2);
	$("#total").val(total);
			 
			 				 

			   var profit= (Number($("#rate").val()) - Number($("#costprice").val()));
