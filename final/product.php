...
<div class="modal fade" id="addProductModal" tabindex="-1" role="dialog">
 ...
 <div class="form-group">
	        	<label for="cgst" class="col-sm-3 control-label">SGST: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-3">
...
<div class="modal fade" id="editProductModal" tabindex="-1" role="dialog">
 ...
 <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-3">
				      <input type="text" class="form-control" id="editcgst" placeholder="cgst" onkeyup="gettax();" name="editcgst" autocomplete="off">
 ...
 <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-3">
				      <input type="text" class="form-control" id="editsgst" placeholder="sgst" onkeyup="gettax();" name="editsgst" autocomplete="off">
