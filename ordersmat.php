...
<div class="panel panel-default">
	  ...
	  <div class="form-group">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">Sub Amount</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="subTotal" name="subTotal" value="<?php echo $data[22] ?>" disabled="true" />
	...
	<div class="form-group">
	  ...
	  <div class="form-group">
				    ...
				    <label for="totalAmount" class="col-sm-3 control-label">Total Amount</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="totalAmount" name="totalAmount" value="<?php echo $data[23] ?>" disabled="true"/>
		   ...
		   <div class="form-group">
				    ...
				    <label for="grandTotal" class="col-sm-3 control-label">Grand Total</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="grandTotal" name="grandTotal" value="<?php echo $data[9] ?>"disabled="true" />
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    ...
				    <label for="vat3" class="col-sm-3 control-label">IGST Total</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="vat3" value="<?php echo $data[20] ?>" name="vat3" disabled="true" />
