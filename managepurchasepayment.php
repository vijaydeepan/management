    ...
    <ul class="dropdown-menu">
      ...
      <li><button class="btn btn-default button1" onclick="location.href = 'return.php';"> <i class="glyphicon glyphicon-plus-sign"></i> Manage  Return </button></li>
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					...
					<button class="btn btn-default button1" type="button" data-toggle="dropdown"    > <img src="4.png" width="30" /> <i class="glyphicon glyphicon-plus-sign"></i> Add Product bill </button>
					<ul class="dropdown-menu">
      <li>	<button class="btn btn-default button" onclick="location.href = 'purchasebill.php?o=add';" data-toggle="modal" data-target="#addSupplierModel"> <i class="glyphicon glyphicon-plus-sign"></i>Add Product bill </button></li>
      <li><button class="btn btn-default button1" onclick="location.href = 'purchasebill.php?o=manord';" > <i class="glyphicon glyphicon-plus-sign"></i> Manage Product bill </button></li>
    </ul>
				</div> <!-- /div-action -->		
