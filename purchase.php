...
<div class="row">
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="remove-messages"></div>
					...
					<button class="btn btn-default button1"   data-toggle="modal" onclick="location.href = 'purchasereport.php';"> <img src="6.png" width="30" /></i> Dealer Report </button>
				</div> <!-- /div-action -->	
				
					<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1"   data-toggle="modal" onclick="location.href = 'dealerpayment.php';"> <img src="6.png" width="30" /></i> Dealer Payment </button>
				</div> <!-- /div-action -->	
      ...
      <li><button class="btn btn-default button1" onclick="location.href = 'supplier.php?o=manord';"> <i class="glyphicon glyphicon-plus-sign"></i> Manage Dealer </button></li>
				...
				<table class="table" id="manageProductTable" style="display:none;">
					<thead>
						<tr>
							<th >id</th>							
							<th>Date</th>
...
<div class="form-group">
    ...
    <label for="orderDate" class="col-sm-3 control-label">Product Name</label>
			    ...
			    <div class="col-sm-8">
			  				<td style="padding-left:20px;">			  					
							   ...
							   <label for="orderDate" class="col-sm-3 control-label">Invoice no</label>
					        	<label class="col-sm-1 control-label">: </label>


			    <div class="col-sm-8">
			  				<td style="padding-left:20px;">			  					
			  					<input type="text" name="invoice_no"  id="invoice_no"  autocomplete="off"  class="form-control" />			  					
			  				</td>
			  		</div>
								  		</div>
  ...
  <div class="col-sm-8">
   ...
   <div class="form-group" style="display:none;">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="quantity1" name="quantity" placeholder="quantity" onkeyup="calculate();" name="quantity" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	         	        
	        ...
	        <div class="form-group">
			  ...
			  <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				  ...
				  <div class="form-group">
	        	<label for="brandName" class="col-sm-3 control-label">gst </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="gst" placeholder="note" name="gst" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	 
			  <div class="form-group">
